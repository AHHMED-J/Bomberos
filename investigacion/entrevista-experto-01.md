...
- Con la encuesta (ya en 7 respuestas, no 4 — falta volver a exportar `Bomberos (respuestas).xlsx`) más estas tres personas identificadas, se supera con margen el mínimo de 4 usuarios reales que pide la tarea, con experto y (al menos) un candidato a extremo cubiertos.
